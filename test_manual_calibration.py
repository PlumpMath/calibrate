...
class TestCalibration(unittest.TestCase):
    ...
    def test_manual_move(self):
        ...
        old_position = self.w.sequences.square.square.getPos()
        # and move
        self.w.key_dict["switch"] = 8
        # do a loop, so it has a chance to read the switch
        self.finish_loop()
        # should now be in new position
        # print self.w.key_dict["switch"]
        # print 'old position', old_position
        self.assertNotEqual(self.w.sequences.square.square.getPos(), old_position)
    ...
    def test_square_moves_to_center_if_no_keypress(self):
        ...
        self.finish_loop()
        # print self.w.sequences.square.square.getPos()
        self.assertEqual(self.w.sequences.square.square.getPos(), Point3(0, 55, 0))
